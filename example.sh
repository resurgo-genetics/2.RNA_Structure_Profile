...
SBATCH -o ~/WorkSpace/2.RNA_Structure_Profile/example.out             # File to which STDOUT will be written
SBATCH -e ~/WorkSpace/2.RNA_Structure_Profile/example.err             # File to which STDERR will be written
...
python ./14_word2vec_embed_b_lstm_1.py 
