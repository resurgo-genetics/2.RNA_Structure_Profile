...
with open('./Gen_data/14_newwork_result_reshow.txt','w') as f:
    ...
    for iter_index in range(60):
        ...
        if  iter_index%9==0 :
            model.save_weights('./Gen_data/14_Att-BLSTM_model_reshow_iter{:03d}.h5'.format (iter_index*10))


print 'finish!'

model.save_weights('./Gen_data/14_w2v_Att-BLSTM_model_reshow_fin.h5')
